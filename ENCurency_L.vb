Public Class ENCurency_L
    ...
    Private Sub ENTextBoxNumeric(ByVal ObjText As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub ENCurency_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        'Font = txtCur.Font
        'Height = txtCur.Height
    End Sub
